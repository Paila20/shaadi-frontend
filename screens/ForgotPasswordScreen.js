...
//       // ✅ Navigate to ResetPassword screen with token returned from backend
//       const token = res.data.token; // Make sure your backend returns { token } along with msg
//       if (!token) {
//         Alert.alert("Error", "Reset token not received. Check your email instead.");
//         return;
//       }
...
//         {
//           text: "Proceed",
//           onPress: () => navigation.navigate("ResetPassword", { token, email }),
//         },
//       ]);
//     } catch (error) {
